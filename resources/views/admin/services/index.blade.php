    ...
    <div class="row justify-content-end mb-3">
        <div class="col-auto">
            <button type="button" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#addServiceModal">
                ...
                <span class="mx-1">Добавить услуг</span>
            </button>
        </div>
    </div>
                ...
                <table class="table table-responsive">
                    <thead>
                        <tr>
                            <th scope="col">№</th>
                            <th scope="col">Имя</th>
                            <th scope="col">Позиция врачей</th>
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-1">
                                    <a class="btn btn-primary text-white"
                                        href="{{ route('admin.services_edit', ['service' => $service->id]) }}">
                                    ...
                                    <form action="{{ route('admin.services_destroy', ['service' => $service->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger text-white" onclick="return confirm('Вы уверены?')"
                                            type="submit">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
