...
@section('title', 'Редактировать данные регистратора')
    ...
    <div class="row">
        <div class="col">
            <div class="app-card p-3">
                ...
                @endif
                <form action="{{ route('admin.registrars_update', ['registrar' => $registrar->id]) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="first_name" placeholder="Имя"
                                    value="{{ $registrar->user->first_name }}">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="last_name" placeholder="Фамилия"
                                    value="{{ $registrar->user->last_name }}">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="date_birth" placeholder="Дата рождения"
                                    value="{{ $registrar->user->date_birth }}">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="phone_number" placeholder="991234567"
                                    value="{{ $registrar->user->phone_number }}">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-auto">
                            <div class="mb-3">
                                <a href="{{ route('admin.registrars_index') }}"
