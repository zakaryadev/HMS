<div class="modal fade" id="addRegistrarModal" tabindex="-1" aria-labelledby="addRegistrarModal" aria-hidden="true">
    <div class="modal-dialog">

        <form action="{{ route('admin.registrars_store') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Добавить нового регистратора</h1>
