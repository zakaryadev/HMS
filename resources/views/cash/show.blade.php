    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 mx-auto">
            <div class="app-card p-3 overflow-hidden shadow-sm">
                ...
                <div class="row">
                    <div class="col-11">
                        <form class="row p-3 align-items-center" action="{{ route('cash.doctor.show') }}" method="POST">
                            @csrf
                            ...
                            <div class="col-2 d-flex flex-column mb-3">
                                ...
                                <a href="{{ route('cash.doctor') }}" class="btn btn-secondary">Отменить филтер</a>
                            </div>
                            <div class="col-2 d-flex flex-column mb-3">
                                <label class="form-label">Действия</label>
                    ...
                    <div class="col-1">
                        <form class="row py-3 align-items-center" action="{{ route('cash.doctor.export') }}"
                            method="POST">
                            @csrf
