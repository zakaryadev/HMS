        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="{{ route('admin.index') }}">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.positions_index' ? 'active' : '' }}"
                                href="{{ route('admin.positions_index') }}">
                                <span class="nav-icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.doctors_index' ? 'active' : '' }}"
                                href="{{ route('admin.doctors_index') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.services_index' ? 'active' : '' }}"
                                href="{{ route('admin.services_index') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.cashiers_index' ? 'active' : '' }}"
                                href="{{ route('admin.cashiers_index') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.registrars_index' ? 'active' : '' }}"
                                href="{{ route('admin.registrars_index') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.patients_index' ? 'active' : '' }}"
                                href="{{ route('admin.patients_index') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() === 'admin.analyse' ? 'active' : '' }}"
                                href="{{ route('admin.analyse') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <span class="nav-link-text">Отчеты</span> </a>
                        </li>
                    </ul>
                </nav>
            </div>
