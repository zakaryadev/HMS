    ...
    <header class="app-header fixed-top">
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                <a href="{{ route('registration.index') }}" id="sidepanel-close"
                    class="sidepanel-close d-xl-none">&times;</a>
                <div class="app-branding">
                    <a class="app-logo" href="{{ route('registration.index') }}">
                        <img class="logo-icon me-2" src="/assets/images/app-logo.svg" alt="logo" />
                        <span class="logo-text">РЕГИСТРАЦИЯ</span>
                    </a>
                </div>
                <!--//app-branding-->
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        <li class="nav-item">
                            ...
                            <a class="nav-link {{ Route::currentRouteName() === 'registration.index' ? 'active' : '' }}"
                                ...
                                <span class="nav-link-text">Пациенты</span> </a>
                            <!--//nav-link-->
                        </li>
                        <!--//nav-item-->
                        <li class="nav-item">
                            <a class="nav-link  {{ Route::currentRouteName() === 'registration.analyse' ? 'active' : '' }}"
                                href="{{ route('registration.analyse') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <span class="nav-link-text">Статистика</span> </a>
                            <!--//nav-link-->
                        </li>
                    </ul>
                    <!--//app-menu-->
